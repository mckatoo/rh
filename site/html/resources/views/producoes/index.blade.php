            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="glyphicon glyphicon-education"></i> CADASTRO DE PROFESSOR - PRODUÇÕES
                    </div>
                </div>
                    @if (count($errors) > 0)
                    ...
                    @endif
                <div class="col-lg-12">
                    {!! Form::open(['route' => ['producoes.store'],'method'=>'POST','id'=>'frmProfessor']) !!}
                        @if(isset($id_prof))
                        ...
                        <div class="form-group col-lg-12">
                            <div class="panel-red col-lg-12">
                                <div class="panel-heading">
                                    <i class="fa fa-warning fa-2x"></i><small> ATENÇÃO - A PRODUÇÃO TEM QUE ESTAR COMPROVADA.</small>
                                </div>
                                <br>
                            </div>
                            <fieldset>
                                <legend>INFORME O TIPO DE PRODUÇÃO, UMA BREVE DESCRIÇÃO E COMPROVANTE DE REGISTRO EM PDF.</legend>

                                <div class="form-group col-lg-6">
                                    <fieldset>
                                        <legend>
                                            Qual o tipo desta produção?
                                        </legend>
                                    ...
                                    <fieldset>
                                        <legend>
                                            Escolha os cursos relacionados a esta produção.
                                        </legend>
                                ...
                                <div class="form-group col-lg-6">
                                    <fieldset>
                                        <legend>
                                            Informe uma breve descrição sobre a produção.
                                        </legend>
                                                    ...
                                                    @foreach ($prod as $p)
                                                        <tr>
                                                            ...
                                                            <td class="middle tdbtn">
                                                                @foreach ($p->producao_curso as $pcurso)
                                                                    <div class="nowrap">
                                                                        {{ $pcurso->curso }}
                                                                    </div>
                                                                @endforeach
                                                            ...
                                                            <td class="middle tdbtn">
                                                                ...
                                                                id="btnLista"
                                                                onclick="$('#bind').load('{{ route('producoes.list_arq',$p->id) }}')">
                                                            ...
                                                            <td class="middle tdbtn">
                                                                ...
                                                                preencheCheckbox(
                                                                    '.checkCursos',
                                                                    {{ $p->producao_curso->lists('id') }}
                                                                );
                                                                ">Editar</a>
                                                            </td>
                                                            <td class="middle tdbtn">
                                                                <a class="btn btn-xs btn-danger" data-toggle="modal" href='#excluirProducao{{ $p->id }}'>Excluir</a>
                                                                <div class="modal fade" id="excluirProducao{{ $p->id }}">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close" data-dismiss="modalx" aria-hidden="true" onclick="fecharModal('#excluirProducao{{ $p->id }}{{ $p->id }}')">&times;</button>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="panel-red col-lg-12">
                                                                                    <div class="panel-heading">
                                                                                        ...
                                                                                        Tem certesa que deseja excluir esta produção?
                                                                                    </div>
                                                                                    <br>
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-default" data-dismiss="modalx" onclick="fecharModal('#excluirProducao{{ $p->id }}')">Cancelar</button>
                                                                                <a href="#" class="btn btn-danger" 
                                                                                onclick="post('{{route('producoes.excluir')}}',
                                                                                {
                                                                                    _token: '{{csrf_token()}}',
                                                                                    id: '{{$p->id}}'
                                                                                });
                                                                                fecharModal('#excluirProducao{{ $p->id }}');
                                                                                ">Excluir</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
