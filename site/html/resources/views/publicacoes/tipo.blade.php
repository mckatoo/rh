		    				...
		    				<div class="modal-dialog">
		    					<div class="modal-content">
		    						<div class="modal-header">
		    							...
		    							<h4 class="modal-title">Cadastrar novo tipo de publicação.</h4>
		    						</div>
		    						<div class="modal-body">
		    							<form action="{{ route('publicacoes.addtipo') }}" method="POST" class="form-inline" role="form">
		    							{{ csrf_field() }}
							                        ...
							                        <div class="modal-dialog">
							                            <div class="modal-content">
							                                <div class="modal-header">
							                                    ...
							                                    <h4 class="modal-title red">Editar Tipo de Publicação</h4>
							                                </div>
							                                <div class="modal-body">
								    							<form action="{{ route('publicacoes.addtipo') }}" method="POST" class="form-inline" role="form">
								    							{{ csrf_field() }}
							                                ...
							                                <div class="modal-body">
							                                    <div class="panel-red col-lg-12">
							                                        <div class="panel-heading">
							                                            ...
							                                            Tem certesa que deseja excluir o tipo de publicação <i>"{{ $t->tipo }}"</i>?
							                                        </div>
							                                        <br>
							                                    </div>
							                                </div>
